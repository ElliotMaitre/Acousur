...
def main():
    for year in YEARS:
        ...
        # Intensities
        I_files = {
            "I0": year_path / "2020_I0.npy",
            "I1": year_path / "2020_I1.npy",
            "I2": year_path / "2020_I2.npy",
            "I3": year_path / "2020_I3.npy",
        }
        ...
        if not file_Lmin.exists() or not file_Lmax.exists():
            I0 = np.load(I_files["I0"])
            I1 = np.load(I_files["I1"])
            I2 = np.load(I_files["I2"])
            I3 = np.load(I_files["I3"])
            P = [I0, I1, I2, I3]
            print("Lmin, Lmax")
